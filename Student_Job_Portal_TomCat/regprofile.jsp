    ...
    <div class="container-xl px-4 mt-4">
        ...
        <div class="row">
            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4 mt-5 mar">
                    <div class="card-header">Details</div>
                    <div class="card-body">
                        <form method="post" action="regcom.jsp">
                            <!-- Form Group (username)-->
                            <div class="mb-3">
                                <label class="small mb-1" for="username">Username (your name will appear under users on the Profile)</label>
                                <input class="form-control" name="username" id="username" type="text" placeholder="Enter your username"  value= "" >
                            </div>
                            <!-- Form Row-->
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="location" name="location" type="text" placeholder="Enter your location" value="Vadlamudi">
                                </div>
                            </div>
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="phonenum" name="phonenum" type="tel" placeholder="Enter your phone number" required>
                                </div>
                                <div class="col-md-6">
                            ...
                            <!-- Save changes button-->
                            <button class="btn btn-primary mt-4" type="submit">Save Reg</button>
                        </form>
                    </div>
                </div>
            </div>
